    ...
    <el-menu-item index="0" class="logo-item">
      <div class="logo-container">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" class="logo-icon">
          <path fill="#409EFF" d="M50 10 L90 30 L90 70 L50 90 L10 70 L10 30 Z" />
          <text x="50" y="60" text-anchor="middle" fill="white" font-size="24" font-weight="bold">
            H
          </text>
        </svg>
        <span class="logo-text">Honeycomb</span>
      </div>
    </el-menu-item>
